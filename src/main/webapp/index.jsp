...
<t:template>
    ...
    <div class="container text-center mt-5">
        ...
        <div class="row justify-content-center align-items-center mt-5">
            <div class="col-md-6 text-end">
                <p style="font-size: 36px; font-family: 'Trebuchet MS', serif; font-weight: bold; color: #007bff;">
                    <span style="padding: 5px;">¡Cuidando vidas con pasión y excelencia!</span>
                </p>
            </div>
            <div class="col-md-6">
                <img src="https://img.freepik.com/foto-gratis/doctor-pensando-sobre-fondo-blanco-aislado_1368-5828.jpg?w=2000"
                     alt="Imagen del hospital" width="500" height="400">
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-4">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <img src="https://cdn-icons-png.flaticon.com/512/1572/1572132.png" class="card-img-top mt-3"
                         alt="Imagen 1" width="25">
                    <div class="card-body text-center">
                        <h5 class="card-title">Agendar Cita</h5>
                        <a class="btn btn-success mx-auto w-75 font-weight-bold"
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://cdn-icons-png.flaticon.com/512/1430/1430402.png" class="card-img-top mt-3"
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://cdn-icons-png.flaticon.com/512/3481/3481061.png" class="card-img-top mt-3"
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="https://dharmamedicinaregenerativa.com.ar/wp-content/uploads/2023/03/2618588-1.png"
